...
::: {#timeline-responsive-script}
<script>
// Elegant mobile optimization for minimalistic timeline
document.addEventListener('DOMContentLoaded', function() {
    function adjustTimelineLayout() {
        const timelineContainer = document.querySelector('.journey-visual .plotly-graph-div');
        if (!timelineContainer) return;
        ...
        if (screenWidth <= 768) {
            const newLayout = {
                height: 300,
                width: 500, // Optimized width for mobile
                margin: {l: 70, r: 120, t: 15, b: 40},
                'xaxis.range': [-0.35, 0.9],
                'font.size': 9
            };
        ...
        // Desktop: Use the clean minimalistic Python defaults
    }
