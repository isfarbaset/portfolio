...
for i, item in enumerate(timeline_data):
    ...
    fig.add_annotation(
        ...
        showarrow=False,
        font=dict(size=10, color='#5D6D7E', family='Inter, Arial, sans-serif'),
        xanchor='left',
        yanchor='middle'
    )
    ...
    fig.add_annotation(
        ...
        showarrow=False,
        font=dict(size=8, color='#85929E', family='Inter, Arial, sans-serif'),
        xanchor='left',
        yanchor='middle'
    )
    ...
    fig.add_annotation(
        ...
        showarrow=False,
        font=dict(size=9, color='#34495E', family='Inter, Arial, sans-serif'),
        xanchor='right',
        yanchor='middle'
    )
...
fig.update_layout(
    ...
    height=350,
    margin=dict(l=25, r=80, t=20, b=60),
    xaxis=dict(
        showgrid=False,
