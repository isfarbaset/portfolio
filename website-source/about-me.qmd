...
const width = Math.min(900, window.innerWidth - 80) - margin.left - margin.right;
...
const journeyItems = g.selectAll(".journey-item")
  ...
  .attr("transform", (d, i) => `translate(0, ${i * (height / journeyData.length) + 20})`);
...
::: {.company-info}
**Shift Digital, Data Operations and Analytics Team** • Birmingham, MI • Nov 2021 - Present
:::

::: {.achievements}
- Currently leading data operations and analytics initiatives for enterprise clients
