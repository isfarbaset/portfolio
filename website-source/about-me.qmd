...
for i, item in enumerate(timeline_data):
    ...
    # Title and organization (right side)
    fig.add_annotation(
        x=0.12,
        y=y_pos + 0.15,
        text=f"<b>{item['title']}</b>",
        showarrow=False,
        font=dict(size=13, color='#2C3E50', family='Inter, Arial, sans-serif'),
        xanchor='left',
        yanchor='middle'
    )
    ...
    fig.add_annotation(
        ...
        showarrow=False,
        font=dict(size=11, color='#5D6D7E', family='Inter, Arial, sans-serif'),
        xanchor='left',
        yanchor='middle'
    )
    ...
    fig.add_annotation(
        ...
        showarrow=False,
        font=dict(size=9, color='#85929E', family='Inter, Arial, sans-serif'),
        xanchor='left',
        yanchor='middle'
    )
    ...
    fig.add_annotation(
        ...
        showarrow=False,
        font=dict(size=10, color='#34495E', family='Inter, Arial, sans-serif'),
        xanchor='right',
        yanchor='middle'
    )
...
fig.update_layout(
    ...
    height=400,
    margin=dict(l=40, r=120, t=20, b=60),
    xaxis=dict(
        showgrid=False,
