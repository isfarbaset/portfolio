...
document.addEventListener('DOMContentLoaded', function() {
    function adjustTimelineLayout() {
        ...
        if (screenWidth <= 430 || (isIOS && screenWidth <= 480)) {
            // iPhone and very small mobile (more aggressive for iOS)
            newLayout = {
                height: 280,
                margin: {l: 20, r: 60, t: 15, b: 50},
                'xaxis.range': [-0.15, 0.5],
    ...
    // Initial adjustment with delay for iOS
    const initialDelay = /iPad|iPhone|iPod/.test(navigator.userAgent) ? 1000 : 500;
    setTimeout(adjustTimelineLayout, initialDelay);
    ...
    window.addEventListener('orientationchange', function() {
        setTimeout(adjustTimelineLayout, 800);
    });
});
</script>
:::
